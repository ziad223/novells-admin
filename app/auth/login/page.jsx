        ...
        <div className="flex items-center justify-center w-full h-[100vh] bg-[url('/media/public/map.svg')] bg-full bg-center dark:bg-[url('/media/public/map-dark.svg')]">
            {
                ...
                <div className="panel w-full max-w-[420px] sm:w-[480px] no-select overflow-hidden">
                    ...
                    <h2 className="mb-2 text-2xl font-bold text-gray-200">{config.text.login}</h2>

                        <p className="mb-7 text-gray-200">{config.text.enter_to_login}</p>

                    <form className="space-y-6" onSubmit={submit}>

                        <div>
                                <label htmlFor="username" className='mb-3 text-gray-200'>{config.text.email}</label>
                        ...
                        <div>
                                <label htmlFor="password" className='mb-3 text-gray-200'>{config.text.password}</label>
